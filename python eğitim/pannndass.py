...
#şuan 10 dan büyük değerleri görebiliriz

### BU KONUYLA ALAKALI ÖRNEK YAPMAK ŞARTT
###BİR VERİ ÇEKTİK DİYELİM BU VERİ ŞÖYLE BİR VERİ OLSUN
#ECZANELER GİBİ DÜŞÜNELİM İSTANBULDAKİ İLÇELERE GÖRE DAĞIŞMIŞ ECZENELER
#GAZİOSMANPAŞA SEMTİ İÇİN 60 TANE ECZANE VAR EYÜPTE ŞU KADAR HER İLÇEDE FARKLI
#SAYILARDA ECZANE VAR BENİM BUNLARI GRUPLAMAM GEREKİYOR SA 
#ÖNCELİKLE VERİYİ ÇEKELİM
eczane=pd.DataFrame(pd.read_excel("verinin adresi"))
eczane.groupby("ilçeler")
#bu işlemi yaptığımızda 
# ilçeler sutununu gruplayacaktır bir obje olacaktır
#ondan sonra belirli işlemler yaparak bu gruplanmış veriden 
#gruplanmış halinde veriyi düzenli şekilde görebileceğigiz
#for döngüsüyle bölgeleri görebiliriz
#peki herrhangi bir ilçeyi görmek istyorsak naparız
eczane.groupby("ilçeler").get_group("ilçe")
#mesela ilçe yerine gop yazarsak gp grubunu görmüş olacagız

## PEKİ GRUPLANDIRMA YAPTIK FARK ETTİYSEK AZ ÖNCE 
# TEK BİR SUTUN İÇİN GRUPLANDIRMA YAPMIŞTIK PEK 
# BİRDEN FAZLA SUTUN İÇİN GRUPLANDIRMA NASIL YAPILIR 
# ONU İNCELEYELİM
eczane=pd.DataFrame(pd.read_excel("verinin adresi"))
#BURADA ANLAŞILIR PAYLAŞTIĞI VERİ SETİ İLE DENEME YAPACAĞIZ
eczane.groupby(["birinci","ikinci"])
# Şu anda ili sutun üzerinde gruplama yaptık mesela söyle
# diyelim birinci dediğimiz şey şehir olsunikinci dediğimiz şey
# cinsiyet olsun hem cinsiyetlere göre hemde şehirlere göre
